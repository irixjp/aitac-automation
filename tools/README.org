...
# 演習環境設定
ansible-playbook -i yyyymmdd_podman_inventory podman_container_deploy.yml -e "reg_username=dockerhub_user" -e "reg_password=dockerhub_pass"
...
# 設定確認
ansible-playbook -i yyyymmdd_class_env_info.txt podman_access_test.yml
#+end_src
